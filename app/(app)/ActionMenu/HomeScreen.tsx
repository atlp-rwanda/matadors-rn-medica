    ...
    <View style={styles.container}>
      ...
      <View style={styles.Footer}>
        <TouchableOpacity onPress={() => handleIconPress("Home")}>
          <SvgXml
            xml={HomeIcon}
            style={[styles.icon, isIconActive("Home") && styles.activeIcon]}
          />
          <Text
            style={[styles.iconText, isIconActive("Home") && styles.activeText]}
          >
            Home
          </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          onPress={() =>
            handleIconPress("Appointment", "(app)/Booking/Doctor_details")
          }
        >
          <SvgXml
            xml={AppointmentIcon}
            style={[
              styles.icon,
              isIconActive("Appointment") && styles.activeIcon,
            ]}
          />
          <Text
            style={[
              styles.iconText,
              isIconActive("Appointment") && styles.activeText,
            ]}
          >
            Appointments
          </Text>
        ...
        <TouchableOpacity onPress={() => handleIconPress("History")}>
          <SvgXml
            xml={HistoryIcon}
            style={[styles.icon, isIconActive("History") && styles.activeIcon]}
          />
          <Text
            style={[
              styles.iconText,
              isIconActive("History") && styles.activeText,
            ]}
          >
            History
          </Text>
        ...
        <TouchableOpacity onPress={() => handleIconPress("Article")}>
          <SvgXml
            xml={ArticleIcon}
            style={[styles.icon, isIconActive("Article") && styles.activeIcon]}
          />
          <Text
            style={[
              styles.iconText,
              isIconActive("Article") && styles.activeText,
            ]}
          >
            Articles
          </Text>
        ...
        <TouchableOpacity onPress={() => handleIconPress("Profile")}>
          <SvgXml
            xml={ProfileIcon}
            style={[styles.icon, isIconActive("Profile") && styles.activeIcon]}
          />
          <Text
            style={[
              styles.iconText,
              isIconActive("Profile") && styles.activeText,
            ]}
          >
            Profile
          </Text>
