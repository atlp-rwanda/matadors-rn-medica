        ...
        >
          ...
          <View style={styles.middlePart}>
            ...
            >
              <TextInput
                ...
                style={[Typography.bold.xLarge, { color: theme === "dark" ? "white" : "black" }]}
                keyboardAppearance={theme === "dark" ? "dark" : "default"}
              />
            </View>
          </View>
          ...
          <View style={styles.belowMiddle}>
            <View style={styles.twoBelowMiddle}>
              ...
              <View style={[styles.DateBorder,{ backgroundColor: theme === "dark" ? "#1F222A" : "#FAFAFA" }]}>
  
                  <Text style={[Typography.semiBold.medium, {color: theme === "dark" ? "white" : "black"}]}>
                  ...
                  <TouchableOpacity onPress={() => setShowDatePicker(true)}>
                    <Image
                      source={theme === "dark" ? require("../../../assets/icons/CalendarWhite.png") : require("../../../assets/icons/Calendar.png")}
                    />
                  </TouchableOpacity>
              </View>
            </View>
