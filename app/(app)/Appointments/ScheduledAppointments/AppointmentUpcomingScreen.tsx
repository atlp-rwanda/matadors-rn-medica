    ...
    <ScrollView>
     <ImageBackground style={styles.cardContainer}>
      ...
      {/* 1st Card*/}
         <ImageBackground style={styles.card}>
           <View style={styles.upperSection}>
             ...
             <View style={styles.DocStatus}>
              <Text>Messaging  -  </Text>
              <View style={{ backgroundColor: "#ffffff" ,padding: 2, paddingHorizontal: 10, borderColor:'#246BFD',borderWidth:2 ,borderRadius: 10, height:30,alignItems:'center' }}>
               <Text style={{ fontFamily: "Urbanist-regular", color: '#246BFD', fontSize:12, }}>Upcoming</Text>
              </View>
           ...
           <View style={styles.CardButtons}>
             <TouchableOpacity style={{ backgroundColor: "#ffffff", marginLeft:10 ,padding: 5, paddingHorizontal: 10, borderColor:'#246BFD',borderWidth:2 ,borderRadius: 20,height:34,alignItems:'center' }}>
               <Text style={{ fontFamily: "Urbanist-regular", color: '#246BFD' }}>Cancel Appointment</Text>
             </TouchableOpacity>
             <TouchableOpacity style={{ backgroundColor: "#246BFD", padding: 5, paddingHorizontal: 10, borderRadius: 20, justifyContent: "center",width:150,height:34,alignItems:'center' }}>
               <Text style={{ fontFamily: "Urbanist-regular", color: "white" }}>Reschedule</Text>
             </TouchableOpacity>
           </View>
         ...
         <ImageBackground style={styles.card}>
           <View style={styles.upperSection}>
             <Image style={styles.cardImage} source={require('../../../../assets/images/Dr jenny.png')}></Image>
             <ImageBackground style={styles.DocDescription}>
             <View style={styles.CardHeader}>
         ...
         <ImageBackground style={styles.card}>
           <View style={styles.upperSection}>
             <Image style={styles.cardImage} source={require('../../../../assets/images/Dr maria.png')}></Image>
             <ImageBackground style={styles.DocDescription}>
             <View style={styles.CardHeader}>
