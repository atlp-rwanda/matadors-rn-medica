      ...
      {/* 1st Card*/}
         <ImageBackground style={styles.card}>
           <View style={styles.upperSection}>
             <Image style={styles.cardImage} source={require('../../../../assets/images/Dr Raul.png')}></Image>
             <ImageBackground style={styles.DocDescription}>
             <View style={styles.CardHeader}>
               <Text style={styles.DocName}> Dr. Raul Zirkind</Text>
             </View>
             <View style={styles.DocStatus}>
              <Text style={{color:'#424242', fontSize:12,fontFamily: "Urbanist-regular" }}>Video Call  -  </Text>
              <View style={{ backgroundColor: "#ffffff" ,padding: 5, paddingHorizontal: 10, borderColor:'#F75555',borderWidth:2 ,borderRadius: 10, height:30,alignItems:'center' }}>
               <Text style={{ fontFamily: "Urbanist-regular", color: '#F75555', fontSize:12, }}>Cancelled</Text>
              </View>
              <Image style={{ marginBottom:10, marginLeft:'6%'}} source={require('../../../../assets/images/VoiceCall.png')}></Image>
             </View>
             <Text style={styles.Date}>Dec 12, 2022  |  16:00 PM</Text>
             </ImageBackground>
           </View>
         ...
         <ImageBackground style={styles.card}>
           <View style={styles.upperSection}>
             <Image style={styles.cardImage} source={require('../../../../assets/images/Dr Keegan.png')}></Image>
             <ImageBackground style={styles.DocDescription}>
             <View style={styles.CardHeader}>
               <Text style={styles.DocName}> Dr. Keegan Dach</Text>
             </View>
             <View style={styles.DocStatus}>
             ...
             <Text style={styles.Date}>Nov 20, 2022  |  10:00 AM</Text>
             </ImageBackground>
           </View>
         ...
         <ImageBackground style={styles.card}>
           <View style={styles.upperSection}>
             <Image style={styles.cardImage} source={require('../../../../assets/images/Dr Drake.png')}></Image>
             <ImageBackground style={styles.DocDescription}>
             <View style={styles.CardHeader}>
             ...
             <Text style={styles.Date}>Nov 08, 2022  |  13:00 PM</Text>
             </ImageBackground>
           </View>
         ...
         <ImageBackground style={styles.card}>
           <View style={styles.upperSection}>
             <Image style={styles.cardImage} source={require('../../../../assets/images/Dr Quinn.png')}></Image>
             <ImageBackground style={styles.DocDescription}>
             <View style={styles.CardHeader}>
               <Text style={styles.DocName}> Dr. Quinn Slatter</Text>
             </View>
             <View style={styles.DocStatus}>
             ...
             <Text style={styles.Date}>Oct 16, 2022  |  09:00 AM</Text>
             </ImageBackground>
           </View>
